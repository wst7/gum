 ...
 */
  ...
  var preload = function(def) {
    return __awaiter(void 0, void 0, void 0, function() {
      return __generator(this, function(_a) {
        switch (_a.label) {
          case 0:
            return [4, Promise.all(PRELOADING.map(function(atlas2) {
              return Promise.resolve(atlas2).then(function(val) {
              }).catch(function(err) {
              });
            }))];
          case 1:
  ...
  var EasingFactories = {
    ...
    "poly-in-out": function(e) {
      return inOut(poly(e));
    },
    "poly-out-in": function(e) {
      return outIn(poly(e));
    },
    "elastic": elastic,
    "elastic-in": elastic,
    "elastic-out": function(a, p) {
      return out(elastic(a, p));
    },
    "elastic-in-out": function(a, p) {
      return inOut(elastic(a, p));
    },
    "elastic-out-in": function(a, p) {
      return outIn(elastic(a, p));
    },
    "back": back,
    "back-in": back,
    "back-out": function(s) {
    ...
    "back-in-out": function(s) {
      return inOut(back(s));
    },
    "back-out-in": function(s) {
      return outIn(back(s));
    }
  };
  var Transition = (
    ...
    (function() {
      ...
      Transition2.prototype.ease = function(easing) {
        ...
        this._easing = (_a = Easing.init(easing, params)) !== null && _a !== void 0 ? _a : IDENTITY;
        return this;
      };
  ...
  var Component = (
    ...
    (function() {
      ...
      Component2.prototype.fit = function(a, b, c) {
        var _a, _b, _c;
        if (typeof a === "object") {
          this._pin.fit((_a = a.width) !== null && _a !== void 0 ? _a : a.x, (_b = a.height) !== null && _b !== void 0 ? _b : a.y, (_c = a.mode) !== null && _c !== void 0 ? _c : b);
        } else {
          this._pin.fit(a, b, c);
        }
        return this;
