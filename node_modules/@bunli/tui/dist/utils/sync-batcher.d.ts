...
export declare function createSyncBatcher<TAction>(applyBatch: (actions: TAction[]) => void, options?: SyncBatcherOptions): SyncBatcher<TAction>;
//# sourceMappingURL=sync-batcher.d.ts.map